...
function Contact() {
  // OnlineStore geoCords do not edit.
    ...
    <div className="max-w-full min-h-[600px]  grid place-items-center lg:grid-cols-2 lg:gap-[10%] pt-16">
      <div className="w-full h-[600px] relative group">
        ...
        >
          ...
          <Marker position={position as LatLngExpression}>
            <Popup>OnlineStore , Kathmandu , Nepal.</Popup>
          </Marker>
        </MapContainer>
      ...
      <div className="space-y-6 pl-4 my-7 lg:my-0">
        ...
        <p className="w-[70%] text-gray-500 font-light break-words">
          Welcome to the contact page of OnlineStore, your go-to destination for
        ...
        <div>
          ...
          <p className="w-[80%] flex space-x-5">
            {" "}
            <span>Phone:</span>{" "}
            <span className="text-gray-500 font-medium">+977-1234567890</span>
          </p>
        </div>
        <Link
          to={"#"}
